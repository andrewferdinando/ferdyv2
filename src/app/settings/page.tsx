        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-5 hover:border-gray-300 hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1 min-w-0">
                <h3 className="font-semibold text-gray-900 mb-2 text-sm">Content Library</h3>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-5 hover:border-gray-300 hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1 min-w-0">
                <h3 className="font-semibold text-gray-900 mb-2 text-sm">Categories & Post Framework</h3>
                <p className="text-gray-600 text-sm mb-4 leading-[1.5]">
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-5 hover:border-gray-300 hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1 min-w-0">
                <h3 className="font-semibold text-gray-900 mb-2 text-sm">Integrations</h3>
                <p className="text-gray-600 text-sm mb-4 leading-[1.5]">

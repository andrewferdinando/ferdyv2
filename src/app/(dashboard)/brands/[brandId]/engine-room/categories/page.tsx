            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div>
                ...
                <div className="relative inline-block group/info mt-2">
                  ...
                  <div className="absolute left-0 top-full mt-1 z-50 hidden group-hover/info:block">
                    <div className="bg-white border border-gray-200 rounded-lg shadow-lg p-4 w-[calc(100vw-2rem)] sm:w-[360px]">
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3">
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center px-4 py-2 bg-gradient-to-r from-[#6366F1] to-[#4F46E5] text-white text-sm font-medium rounded-lg hover:from-[#4F46E5] hover:to-[#4338CA] transition-all duration-200"
                >
                  Add Category
                </button>
              </div>
                                ...
                                if (subcat.isEvent && subcat.eventRules) {
                                  ...
                                  rows.push(
                                    <tr key={`event-group-${subcat.subcategoryId}`}>
                                      <td className="px-3 sm:px-6 py-4 text-sm text-gray-900 font-medium">{subcat.subcategoryName}</td>
                                      <td className="px-3 sm:px-6 py-4 text-sm text-gray-900">{SUBCATEGORY_TYPE_LABELS[(firstRule.subcategories?.subcategory_type as SubcategoryType) || 'other']}</td>
                                      <td className="px-3 sm:px-6 py-4 text-sm text-gray-900">Specific Date/Range</td>
                                  ...
                                  rows.push(
                                    <tr key={rule.id}>
                                      <td className="px-3 sm:px-6 py-4 whitespace-nowrap text-sm text-gray-900 font-medium">{subcat.subcategoryName}</td>
                                      <td className="px-3 sm:px-6 py-4 whitespace-nowrap text-sm text-gray-900">{SUBCATEGORY_TYPE_LABELS[(rule.subcategories?.subcategory_type as SubcategoryType) || 'other']}</td>
                                      <td className="px-3 sm:px-6 py-4 whitespace-nowrap text-sm text-gray-900">{freqLabel}</td>
                                      <td className="px-3 sm:px-6 py-4 text-sm">
                                  ...
                                  rows.push(
                                    <tr key={`subcategory-no-rules-${sub.id}`}>
                                      <td className="px-3 sm:px-6 py-4 whitespace-nowrap text-sm text-gray-900 font-medium">{sub.name}</td>
                                      <td className="px-3 sm:px-6 py-4 whitespace-nowrap text-sm text-gray-900">{SUBCATEGORY_TYPE_LABELS[(sub.subcategory_type as SubcategoryType) || 'other']}</td>
                                      <td className="px-3 sm:px-6 py-4 whitespace-nowrap text-sm text-gray-500">No schedule yet</td>
                          ...
                          <table className="min-w-full divide-y divide-gray-200">
                            <thead>
                              <tr>
                                ...
                                <th className="px-3 sm:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Schedule</th>
                                <th className="px-3 sm:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Days / Dates</th>

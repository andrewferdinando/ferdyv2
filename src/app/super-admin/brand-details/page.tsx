...
export default function BrandDetailsPage() {
  ...
  const handleAIGeneration = (prompt: string) => {
    ...
    console.log('Generating brand details with prompt:', prompt);
    ...
    <AppLayout>
      <div className="flex-1 overflow-auto">
        ...
        <div className="bg-white border-b border-gray-200 px-4 sm:px-6 lg:px-10 py-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-1 text-sm">Manage your business information for personalized content generation</p>
            </div>
            <div className="flex items-center space-x-3">
              <button
                onClick={handleGenerateWithAI}
                className="bg-white border border-gray-300 text-gray-700 text-sm font-medium rounded-lg hover:bg-gray-50 hover:border-gray-400 transition-all duration-200 px-4 py-2 flex items-center space-x-2"
              >
        ...
        <Modal
          ...
          title="Generate Brand Details with AI"
          subtitle="Describe your business and we'll generate comprehensive brand details"
          maxWidth="md"
        >
          <Form onSubmit={(e) => { e.preventDefault(); }}>
            <FormField label="Business Description" required>
              <Textarea
                placeholder="Describe your business, what you do, your target audience, and any specific details you want included..."
                rows={6}
              />
            </FormField>

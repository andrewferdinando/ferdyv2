  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="mx-auto max-w-3xl px-6 py-16 sm:px-8 lg:px-12">
        <p className="text-base leading-7 text-gray-700">
          Welcome to Ferdy AI. These Terms and Conditions (&quot;Terms&quot;) govern your use of Ferdy AI
          (&quot;the Service&quot;), provided by Ferdy AI Ltd (&quot;we,&quot; &quot;us,&quot; or &quot;our&quot;).
        ...
        <div className="mt-12 space-y-10">
          <section>
            ...
            <div className="mt-4 space-y-4 text-base leading-7 text-gray-700">
              <p>
                <span className="font-medium text-gray-900">Service:</span> Ferdy AI, an AI-powered content
                creation and scheduling platform.
              </p>
              <p>
                <span className="font-medium text-gray-900">User:</span> Any individual or entity accessing or
                using the Service.
              </p>
              <p>
                <span className="font-medium text-gray-900">Content:</span> Any text, images, videos, or other
          ...
          <section>
            ...
            <div className="mt-4 space-y-4 text-base leading-7 text-gray-700">
              <p>Ferdy AI retains ownership of all software, branding, and proprietary technology.</p>
              <p>
                Users retain ownership of content created using the Service but grant us a license to use
                anonymized data for improvements and analytics.
              </p>
              <p>Users may not copy, modify, or distribute the Service without permission.</p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="mt-4 space-y-4 text-base leading-7 text-gray-700">
              <p>The Service is provided &quot;as is&quot; without warranties of any kind.</p>
              <p>
                We are not responsible for indirect, incidental, or consequential damages related to the use of
                the Service.
              </p>
              <p>
                Our maximum liability under these Terms is limited to the amount paid by the user in the last 12
                months.
              </p>
            </div>
          </section>
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-900">9. Privacy Policy</h2>
            <p className="mt-4 text-base leading-7 text-gray-700">
              Your use of Ferdy AI is also governed by our Privacy Policy, which outlines how we collect, use, and
              protect your data.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-4 text-base leading-7 text-gray-700">
              We may update these Terms periodically. Continued use of the Service after changes are posted
              constitutes acceptance of the new Terms.
            </p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-gray-900">11. Governing Law and Dispute Resolution</h2>
            <p className="mt-4 text-base leading-7 text-gray-700">
              These Terms are governed by the laws of New Zealand. Any disputes shall be resolved through
              arbitration or courts in New Zealand.
            </p>
          </section>
